...
Der Titel \emph{Symmetry as a Design Axis in Variational Quantum Learning} fasst den konservativeren Claim der Experimente besser zusammen. Die Frage ist nicht nur, ob man volle $D_4$-Symmetrie bewusst brechen sollte. $C_4$ ist kompetitiv und in kleinen Datenregimen punktuell besser, aber es schlägt $D_4$ nicht robust. Deshalb wäre die harte Aussage \emph{man sollte volle Symmetrie brechen} wissenschaftlich zu stark.
