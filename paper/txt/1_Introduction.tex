...
exactly enumerable, and structurally transparent: the relevant board
...
should be made trainable. The Meyer-style baseline couples local board
neighbourhoods, whereas the label is decided by complete winning lines. Our
